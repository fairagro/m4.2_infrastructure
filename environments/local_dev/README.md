...
- `sql-to-arc` chart: `helmcharts/fairagro-advanced-middleware-sql-to-arc` (Zalando `postgresql` CR, dump bootstrap Job, converter Job). Values: `values/fairagro-advanced-middleware-sql-to-arc.yaml`.
